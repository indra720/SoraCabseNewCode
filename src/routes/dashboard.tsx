    ...
    function DashboardPage() {
      ...
      return (
        <div className="min-h-screen space-y-2 bg-transparent ">
          <PageHeader
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            ...
            <div className="surface-card rounded-2xl p-4">
              <div className="mb-4">
                <h3 className="text-lg font-bold text-foreground">Bike Utilization</h3>
                <p className="text-sm text-slate-500">Fleet-wide today</p>
              </div>
              <div className="h-52">
                <ResponsiveContainer width="100%" height="100%">
                  <RadialBarChart
                ...
                {utilization.map((u) => (
                  <div key={u.name} className="flex items-center justify-between text-xs">
                    <div className="flex items-center gap-2">
                      <span
                        className="h-2 w-2 rounded-full px-3 py-1 font-semibold"
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            ...
            <div className="surface-card rounded-2xl p-4">
              <div className="mb-4 flex items-center justify-between">
                ...
                <Badge variant="secondary" className="rounded-full px-3 py-1 font-semibold text-[10px]">
                  Live
                </Badge>
              </div>
